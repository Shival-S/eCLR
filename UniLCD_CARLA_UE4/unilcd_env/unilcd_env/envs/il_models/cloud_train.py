...
def train(data_folder, save_path):
    ...
    if hasattr(infer_action1, 'module'):
        torch.save(infer_action1.module.state_dict(), save_path)
    else:
        torch.save(infer_action1.state_dict(), save_path)
